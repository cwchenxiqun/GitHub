package com.armorhero.service.system.role;
...
public class RoleService {
    ...
    public List<Role> listAllERRoles(Role role) throws Exception {
        return (List<Role>) dao.findForList("RoleMapper.listAllERRoles", role);
    }
