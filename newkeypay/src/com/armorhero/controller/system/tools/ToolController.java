package com.armorhero.controller.system.tools;
...
import com.armorhero.util.MapDistance;
import com.armorhero.util.PageData;
import com.armorhero.util.PathUtil;
import com.armorhero.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	public Object createTwoDimensionCode(){
		...
		if(null == encoderContent){
			...
			try {
				String filePath = request.getServletContext().getRealPath("/") + Const.FILEPATHTWODIMENSIONCODE + encoderImgId;  //存放路径
