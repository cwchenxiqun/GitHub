package com.armorhero.controller.system.login;
...
import com.armorhero.entity.system.Menu;
...
import com.armorhero.util.AppUtil;
import com.armorhero.util.Const;
import com.armorhero.util.DateUtil;
import com.armorhero.util.PageData;
import com.armorhero.util.RightsHelper;
			...
			if(null == code || "".equals(code)){
				...
				if(Tools.notEmpty(sessionCode) && sessionCode.equalsIgnoreCase(code)){
					...
					if(pd != null){
						...
						if(StringUtils.isNotEmpty(pd.getString("ROLE_ID"))){
							Role role = roleService.getRoleById(pd.getString("ROLE_ID"));
							if(null != role && Const.SYSTEM_ROLE_ID.equals(role.getPARENT_ID())){//系统账号
								session.setAttribute(Const.SESSION_USER_ROLE_TYPE, Const.SYSTEM_ROLE_ID);
							}else if(null != role && Const.DEALER_ROLE_ID.equals(role.getPARENT_ID())){//经销商账号
								session.setAttribute(Const.SESSION_USER_ROLE_TYPE, Const.DEALER_ROLE_ID);
							}
						}
