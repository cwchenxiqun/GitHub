                        ...
                        <table class="center" style="width:100%;">
                            <tr height="35">
                                ...
                                <td style="width:100px;" class="center"
                                    ...
                                    <a href="role.do?ROLE_ID=${role.ROLE_ID }" style="text-decoration:none; display:block;">
                            ...
                            <c:if test="${QX.cha == 1 }">
                                <c:forEach items="${roleList_z}" var="var" varStatus="vs">
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${QX.edit == 1 }">
                                            <td style="width:60px;" class="center"><label><input type="checkbox" class="ace-switch ace-switch-3" id="qx3${vs.index+1}"
                                                                                                 <c:if test="${fx_qx == 1 }">checked="checked"</c:if> onclick="kf_qx3(this.id,'${var.QX_ID}','fxqx')"/><span class="lbl"></span></label></td>
